...
# Logging helper
LOG_FILE = "comprehensive_benchmarking.log"
def log_message(msg):
...
def main():
    t_start = time.time()
    log_message("=== STARTING COMPREHENSIVE OCR BENCHMARK ===")
    ...
    log_message(f"Results saved to {output_dir}/comprehensive_benchmark_results.csv")
    
    elapsed_time = time.time() - t_start
    log_message(f"=== COMPREHENSIVE OCR BENCHMARK COMPLETED IN {elapsed_time/60:.2f} MINUTES ===")
